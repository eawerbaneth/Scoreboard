...
DATABASES = {
    'default': {
        ...
        'NAME': 'C:/Users/townse2/Documents/scoreboared.sqlite3.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '3%^6awc6p-guqk-nz+ktmojj)z5_p(lum@r!nempl2(hy2u25s'
